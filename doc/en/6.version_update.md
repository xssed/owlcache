...
|  V0.5.0-beta |  2024-08-23  |  In the high-concurrency scenario of 'url cache', limit the number of concurrent calls to the same backend interface to relieve pressure.  |      
|  V0.5.1-beta |  2025-02-21  |  When querying a cluster, you can specify a target node to improve query efficiency&Fixed an issue where tokens were invalidated when modifying cluster configurations via http  |      